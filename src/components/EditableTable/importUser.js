...
import { Button, Upload, Modal, Progress, Alert } from "antd";
import { FileExcelFilled, UploadOutlined, DownloadOutlined } from "@ant-design/icons";
...
function ImportUser(prop) {
    ...
    return (
        <div>
            ...
            <Esign showEsign={showEsign} userType={userType} fileID={fileID} handleEsignCancle={handleEsignCancle} handlePopUpClose = {handleCancel}/>
        </div>
    )
}

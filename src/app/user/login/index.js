...
const Login = () => {
  ...
  const [successfulAccountCreationFlag, setSuccessfulAccountCreationFlag] =
    useState(false);
  ...
  return (
    <>
        ...
        <div className="login-split ">
          ...
          <div className="login-right">
            ...
            <div className="forgot-pwd">
              ...
              <p onClick={forgotPassword} style={{ cursor: "pointer" }}>
            ...
            <p className="signup-text">
              ...
              <span className="sign-up" onClick={showModal}>
                Sign up
              </span>
            </p>
      ...
      <div>
        <Modal
          title={
            forgotPasswordFlag && successfulAccountCreationFlag == false
              ? "Forgot Password"
              : successfulAccountCreationFlag
              ? ""
              : "Signup"
          }
        ...
        >
          {successfulAccountCreationFlag == false ? (
            <>
              <p
                className="signup-modal-text"
                style={{ display: "flex", justifyContent: "center" }}
              >
                {forgotPasswordFlag
                  ? "No worries, lets reset your password to help you get back in"
                  : "Hey there, lets create your account!"}
              </p>
              <div className="signup-center">
                ...
                <Button className="login-btn" onClick={registerAccount}>
                  {forgotPasswordFlag ? "Generate Password" : "Create Account"}
                </Button>
              </div>
            </>
          ) : (
            <div className="signup-center">
              <div>
                <img src={SuccessfulImage} height="300px" width="360px" />
              </div>
              <Alert
                style={{ marginTop: "20px" }}
                message={
                  forgotPasswordFlag ? "Password Generated" : "Account Created"
                }
                description={
                  <p>
                    Check your inbox for the password and{" "}
                    <a onClick={() => window.location.reload()}>login here</a>
                  </p>
                }
                type="success"
                showIcon

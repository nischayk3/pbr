...
class ChartPersonalization extends Component {
    constructor(props) {
        ...
        const handleTitleChange = () => {
            const { isShare, isSave, isNew, isSaveAs, isLoad, isDiscard } =
                this.state;
            if (isDiscard) {
                return (
                    <span>
                        <InfoCircleTwoTone twoToneColor='orange' /> Discard
                        Changes
                    </span>
                );
            }
            ...
            if (isLoad) {
                return (
                    <span>
                        <InfoCircleTwoTone twoToneColor='orange' /> Load
                    </span>
                );
            }
            if (isNew) {
                return (
                    <span>
                        <InfoCircleTwoTone twoToneColor='orange' /> Unsaved
                        Changes
                    </span>
                );
            }
    ...
    render() {
        const { isShare, isSave, isNew, isLoad, isDiscard, visible } =
            this.state;
        return (
                ...
                <div className='viewCreation-block'>
                    ...
                    <div className='viewCreation-btns'>
                        <Button
                            ...
                            onClick={() =>
                                this.setState({ visible: true, isNew: true })
                            }
                        >
                            <PlusOutlined /> New
                        </Button>
                        <Button
                            className='viewCreation-loadBtn'
                            onClick={() =>
                                this.setState({ visible: true, isLoad: true })
                            }
                        >
                        ...
                        <Button
                            ...
                            onClick={() =>
                                this.setState({ visible: true, isSave: true })
                            }
                        >
                            <SaveOutlined /> Save
                        </Button>
                        ...
                        <Button
                            ...
                            onClick={() =>
                                this.setState({ visible: true, isShare: true })
                            }
                        >
                        ...
                        {isLoad && (
                            <div>
                                <p>
                                    ...
                                    <br /> Do you want to save or discard them ?
                                </p>

        ...
        onRow={(record) => ({
          onClick: () => {
            ...
            props.setViewData?.({
              ...
              chartDispId: record.chart_disp_id,
              status: record.chart_status,
              searchValue: record.chart_disp_id,
              chartVersion: record.chart_version,
              createdBy: record.created_by,
              viewId: record.chart_info[0].view_id,
            });

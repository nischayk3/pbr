  ...
  return (
    <div className='custom-wrapper'>
      ...
      <div className='custom-content-layout'>
        <Card className='workflow_head'>
          <div>
            ...
            <p className='dash-text'>
              Today is a great day to approve some records! Let's take look.
            </p>
          </div>
        ...
        <div
          className='workflow_items approve-wrapper'
          style={{ width: '305px' }}
        >
          {tilesData.map((item, index) => {
            return (
              <div
                onClick={() => tilesClicked(item)}
            ...
            <Card
              title={
                <div className='table-head'>
                  {cardTitle}
                  <DownloadOutlined
                    style={{ color: '#093185', marginLeft: '25px' }}
                  />
                </div>
              }

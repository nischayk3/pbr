...
class Uploader extends Component {
    ...
    onChange = info => {
        ...
        const nextState = {};
        if (info.file.type !== 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' && info.file.type !== 'application/vnd.ms-excel') {
            ...
            <div className='bg-white'>
                ...
                <div className="div-card custom-data-configure">
                    ...
                    {this.state.changeScreen ?
                        ...
                        : <PublishScreen screen={this.state.changeScreen} tableColumns={this.state.tableColumns} />
                    }
                </div>

            ...
            {(rows, { add, remove }) => (
                <>
                        ...
                        <tr
                            ...
                            <td >
                                <Popconfirm title="Are you Sure you want to delete?" onConfirm={() => remove(name)} disabled={props.show} >
                                    <DeleteTwoTone twoToneColor="red" style={{ fontSize: '18px',paddingRight:'20px' }} disabled={props.show} />
                                </Popconfirm>
                            </td>
                            <td >
                                <Form.Item
                    ...
                    <tr>
                        ...
                        <td>
                    <Form.Item>
                        <div className="add-row-btn" onClick={() => add()} > <PlusOutlined style={{ color: '#093185',marginRight:'5px' }} /> Add new row </div>
                    </Form.Item>
                    </td>
                    </tr>
                </>

...
describe('The App', () => {
  ...
  it('should login successfully and show dashboard', () => {
    ...
    cy.get('.sub-header-btns > :nth-child(1)', {
      timeout: 20000,
    }).click({ force: true });
    cy.get('.input_view > .ant-select > .ant-select-selector', {
      timeout: 20000,
    }).click();
    ...
    cy.get(
      ':nth-child(2) > :nth-child(1) > .ant-card > .ant-card-body > .grid-2-columns > .select_field > .ant-select > .ant-select-selector > .ant-select-selection-item'
    ).click();
    cy.get(
    ...
    cy.get(
      ':nth-child(2) > :nth-child(1) > .ant-card > .ant-card-body > .ant-btn > span'
    ).click();
    cy.get(
      ':nth-child(3) > :nth-child(1) > .ant-card > .ant-card-body > :nth-child(1) > .select_field > .ant-select > .ant-select-selector > .ant-select-selection-item'
    ).click();
    cy.get(
    ...
    cy.get(
      '[style="margin-top: 10px;"] > :nth-child(1) > .ant-select > .ant-select-selector > .ant-select-selection-item'
    ).click();
    cy.get(
    ...
    cy.get(
      '[style="margin-top: 10px;"] > :nth-child(2) > .ant-select > .ant-select-selector > .ant-select-selection-item'
    ).click();
    cy.get(
      ':nth-child(9) > :nth-child(1) > .ant-select-dropdown > :nth-child(1) > .rc-virtual-list > .rc-virtual-list-holder > :nth-child(1) > .rc-virtual-list-holder-inner > .ant-select-item-option-active > .ant-select-item-option-content'
    ).click();
    cy.get(
      ':nth-child(3) > :nth-child(1) > .ant-card > .ant-card-body > .ant-btn > span'
    ).click();
    ...
    cy.get('.sub-header-btns > :nth-child(2) > span').click({ force: true });
